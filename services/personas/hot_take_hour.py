...
hot_take_hour = Persona(
    ...
    voice_notes=(
        ...
        "You may also receive \"hth_season_narratives\" — the running storylines Dave and Tony have been carrying ALL SEASON. "
        "These are their long-running grudges, predictions, and obsessions. "
        "Reference at least one of these per segment. "
