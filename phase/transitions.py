...
ALLOWED: dict[str, set[Phase]] = {
    ...
    "awards_vote":         {Phase.OFFSEASON_AWARDS_OPEN, Phase.REGULAR_SEASON_COMPLETE},
    "awards_close":        {Phase.OFFSEASON_AWARDS_OPEN, Phase.REGULAR_SEASON_COMPLETE},
